...
def define_clfs_params(grid_size):
    ...
    'DT':   {'criterion': ['gini', 'entropy'], 'max_depth': [1,5,10,20,50,100], 'min_samples_split': [2,5,10], 'random_state': [SEED]},
    ...
    'DT':   {'criterion': ['gini', 'entropy'], 'max_depth': [5,20], 'min_samples_split': [2,10], 'random_state': [SEED]},
